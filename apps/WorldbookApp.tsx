            ...
            <div className="flex-1 overflow-y-auto p-5 pb-24 space-y-4 no-scrollbar relative z-0">
                ...
                {Object.entries(groupedBooks).map(([category, books]) => (
                    <div key={category} className="animate-slide-up">
                        ...
                        {/* Group Items */}
                        <div className={`grid transition-all duration-300 ${expandedCategory === category ? 'grid-rows-[1fr] opacity-100 mt-2' : 'grid-rows-[0fr] opacity-0'}`}>
                            <div className="overflow-hidden">
                                <div className="space-y-3 pl-2 pb-1">
                                    {books.map(book => (
